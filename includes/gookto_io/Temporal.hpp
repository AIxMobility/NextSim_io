...
class MetadataBase
{
 ...
 public:
    ...
    MetadataBase(u_ll id_val, float length_val, float freeFlowSpeed_val,
                 float max_spd_val, float min_spd_val, float waveSpeed_val,
                 size_t maxVehicle_val, float Qmax_val)
    {
        id = id_val;
        _length = length_val;
    ...
    void setLength(float length_val)
    {
        _length = length_val;
    }
    float getLength()
    ...
    // for link and cell
    virtual void setFreeFlowSpeed(float val)
    {
        _freeFlowSpeed = val;
    }
    ...
    virtual void setWaveSpeed(float val)
    {
        _waveSpeed = val;
    }
    virtual void setMaxVehicle(size_t val)
    {
        _maxVehicle = val;
    }
    virtual void setMaxSpeed(float val)
    {
        _max_spd = val;
    }
    virtual void setMinSpeed(float val)
    {
        _min_spd = val;
    }

    virtual float getFreeFlowSpeed()
    {
        return _freeFlowSpeed;
    }
    virtual float getQmax()
    {
        return _Qmax;
    }
    virtual float getWaveSpeed()
    {
        return _waveSpeed;
    }
    virtual size_t getMaxVehicle()
    {
        return _maxVehicle;
    }
...
class InputCell : public MetadataBase
{
 ...
 public:
    ...
    InputCell(u_ll id_val, float offset_val, float length_val)
        : MetadataBase(id_val, length_val)
    {
        offset = offset_val;
    }

    // InputCell(u_ll id_val, float offset_val, float length_val, InputLink*
    // parent_link):
    //     MetadataBase(id_val, length_val, parent_link->getFreeFlowSpeed(),
    //                 parent_link->getMaxSpeed(),parent_link->getMinSpeed(),
    //                 parent_link->getWaveSpeed(),parent_link->getMaxVehicle(),
    //                 parent_link->getQmax())
    // {
    //     offset = offset_val;
    ...
    void setOffset(float offset_val)
    {
        offset = offset_val;
    }
    float getOffset()
...
{
 private:
    // <segment block="true" end_point="169.15" id="20000102240301"
    // init_point="0.0" left_lc="false" right_lc="false"/>
    u_ll id;
    bool blocked;
 ...
 public:
    InputSegment(u_ll id_val, bool block, bool left_lc_val, bool right_lc_val,
                 float init_point_val, float end_point_val)
        : id{ id_val },
          blocked{ block },
          left_lc{ left_lc_val },
...
class InputLane
{
 ...
 public:
    // constructors
    InputLane(u_ll id_val, u_ll left_lane_id_val, u_ll right_lane_id_val,
              int num_cell_val);
    InputLane(u_ll id_val, u_ll left_lane_id_val, u_ll right_lane_id_val,
    ...
    std::vector<InputCell *> getCells()
    {
        return CellArr;
    }
    std::vector<InputSegment *> getSegments()
    {
        return SegmentArr;
    }
};
