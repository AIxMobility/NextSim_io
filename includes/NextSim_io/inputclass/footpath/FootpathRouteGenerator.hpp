/**
 * @file FootpathRouteGenerator.hpp
 * @version 1.0
 * @author Yeonwoo Yu
 */

#ifndef FOOTPATHROUTEGENERATOR_HPP
#define FOOTPATHROUTEGENERATOR_HPP
...
/**
 * @class FootpathRouteGenerator
 * @brief Generates pedestrian footpath routes using Dijkstra's algorithm.
 */
class FootpathRouteGenerator {
public:
    /** @brief Constructor */
    FootpathRouteGenerator();

    /** @brief Destructor */
    ~FootpathRouteGenerator() = default;
...
#endif // FOOTPATHROUTEGENERATOR_HPP
